...
class Application(Frame):
                ...
                if e.x >= xn and e.x <= xk and e.y >= yn and e.y <= yk:
                    ...
                    if hit_status == 0:
                        ...
                        if self.checkFinish("user") < 10:
                            ...
                            showinfo("Морський бій", "Ви перемогли!")
                    break
    ...
    def __init__(self, master=None):
        ...
        self.m.add_cascade(label = "Натисніть сюди для початку гри в Морський бій",menu = self.m_play)
        self.m_play.add_command(label="Нова гра", command = self.new_game)
